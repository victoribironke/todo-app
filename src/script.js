  ...
  checks.forEach((check) => {
    check.addEventListener("click", () => {
      ...
      if (isChecked) {
        ...
        check.id = "";
        if (
          (_a = check.parentElement) === null || _a === void 0
            ? void 0
            : _a.children[1]
        ) {
        ...
        for (let i = 0; i < taskList.length; i++) {
          taskList[i].task ===
          ((_b = check.parentElement) === null || _b === void 0
            ? void 0
            : _b.children[1].textContent)
            ? newTaskList.push({
                done: false,
        ...
        check.id = "change";
        if (
          (_c = check.parentElement) === null || _c === void 0
            ? void 0
            : _c.children[1]
        ) {
        ...
        for (let i = 0; i < taskList.length; i++) {
          taskList[i].task ===
          ((_d = check.parentElement) === null || _d === void 0
            ? void 0
            : _d.children[1].textContent)
            ? newTaskList.push({
                done: true,
                task: taskList[i].task,
              })
  ...
  crosses.forEach((cross) =>
    cross.addEventListener("click", () => {
      ...
      for (let i = 0; i < taskList.length; i++) {
        if (
          taskList[i].task !==
          ((_a = cross.parentElement) === null || _a === void 0
            ? void 0
            : _a.children[1].textContent)
        ) {
          newTaskList.push(taskList[i]);
        }
      }
...
taskInput === null || taskInput === void 0
  ? void 0
...
themeIcon === null || themeIcon === void 0
  ? void 0
